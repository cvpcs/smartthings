 ...
 *
 *  Z-Wave Door/Window Sensor for Carbon Monoxide Relay
 */
...
metadata {
	definition (name: "Z-Wave Door/Window Sensor for Carbon Monoxide Relay", namespace: "cvpcs", author: "Austen Dicken", genericHandler: "Z-Wave") {
		...
		fingerprint mfr:"014A", prod:"0004", model: "0002", deviceJoinName: "Ecolink Door/Window Sensor (Carbon Monoxide Detector Relay)"
	}
...
def sensorValueEvent(value) {
	if (value) {
		createEvent(name: "smoke", value: "clear", descriptionText: "$device.displayName is clear", displayed: false)
		createEvent(name: "carbonMonoxide", value: "clear", descriptionText: "$device.displayName is clear")
	} else {
		createEvent(name: "smoke", value: "detected", descriptionText: "$device.displayName detected carbon monoxide", displayed: false)
