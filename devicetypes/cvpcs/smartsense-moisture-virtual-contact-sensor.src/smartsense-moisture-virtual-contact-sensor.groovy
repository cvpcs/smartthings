...
metadata {
	definition(name: "SmartSense Moisture Virtual Contact Sensor", namespace: "cvpcs", author: "Austen Dicken", runLocally: true, executeCommandsLocally: false, mnmn: "SmartThings", vid: "generic-leak", genericHandler: "Zigbee") {
...
private Map getMoistureResult(value) {
	...
	if (value == "wet") {
        ...
        log.debug 'Sent contact closed message'
    }
	else {
		descriptionText = '{{ device.displayName }} is dry'
        sendEvent(name: 'contact', value: 'open')
        log.debug 'Sent contact open message'
    }
